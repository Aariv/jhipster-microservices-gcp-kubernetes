...
import com.ariv.demo.service.StoreService;
...
/**
 * REST controller for managing {@link com.ariv.demo.domain.Store}.
 */
@RestController
@RequestMapping("/api")
public class StoreResource {
     ...
     */
    @GetMapping("/stores")
    public ResponseEntity<List<Store>> getAllStores(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
